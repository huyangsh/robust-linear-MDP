...
print(reward_nominal, reward_perturb)
exit()
...
fig.savefig(f"./log/linear_PG_policy_{eps:.2f}_{eta:.2f}_{timestamp}.png", dpi=300)

fig = plt.figure(figsize=(5,5))
ax = fig.add_subplot(1,1,1)
ax.plot(t_list, reward_list, label="$\varepsilon=0.2$")
fig.savefig(f"./log/linear_PG_reward_{eps:.2f}_{eta:.2f}_{timestamp}.png", dpi=300)